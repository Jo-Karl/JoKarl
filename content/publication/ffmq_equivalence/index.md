...
abstract = "Objectives The goal of the current study was to investigate the universality of the five-factor model of mindfulness and the measurement equivalence of the Five-Facet Mindfulness Questionnaire (FFMQ).
Methods The study used FFMQ data from published and unpublished research conducted in 16 countries (total N = 8541). Using
CFA, different models, proposed in the literature, were fitted. To test the cross-cultural equivalence of the best fitting model, a multi-group confirmatory factor analysis was used. Further, the equivalence of individual facets of the FFMQ and potential sources of non-equivalence was explored.
